...
deploy-sapolia:
	forge script script/DeployFundMe.s.sol --rpc-url $(SEPOLIA_RPC_URL) --broadcast --private-key $(SEPOLIA_PRIVATE_KEY) --verify --etherscan-api-key $(ETHERSCAN_VERIFY_KEY) -vvvv
